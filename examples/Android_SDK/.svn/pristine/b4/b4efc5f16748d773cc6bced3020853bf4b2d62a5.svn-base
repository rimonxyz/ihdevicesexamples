...
/**
 * Public API for the KD926
 * <p> The class provides methods to control KD926 device.
 * You need to call the device method, and then call the connection method
 * <p> If you want to connect a KD926 device, you need to call{@link iHealthDevicesManager#startDiscovery} to discovery a new KD926 device,
 * and then call{@link iHealthDevicesManager#connectDevice}to connect KD926 device.
 */
public class Bp926Control implements DeviceControl {

    private static final String TAG = "Bp926Control";
    ...
    /**
     * a constructor for Bp926Control.
     *
    ...
    /**
     * Get the number of historical data in the KD926,select memory size.
     * <ul>
     * <li>Attention, call {@link iHealthDevicesManager#registerClientCallback(iHealthDevicesCallback)} firstly.</li>
    ...
    public void getOfflineNum(int memSize) {
        ...
        a1InsSet.setMemory_Size(memSize);
        a1InsSet.getOffLineDataNum();
    }

    /**
     * Get the value of historical data in the KD926
     * <ul>
     * <li>Attention, call {@link iHealthDevicesManager#registerClientCallback(iHealthDevicesCallback)} firstly.</li>
     * <li>This is an asynchronous call, it will not return immediately.
     * Callback {@link iHealthDevicesCallback#onDeviceNotify(String, String, String, String)} will be triggered.</li>
    ...
    /**
     * Get the value of historical data over  in the KD926
     * <ul>
     * <li>Attention, call {@link iHealthDevicesManager#registerClientCallback(iHealthDevicesCallback)} firstly.</li>
     * <li>This is an asynchronous call, it will not return immediately.
     * Callback {@link iHealthDevicesCallback#onDeviceNotify(String, String, String, String)} will be triggered.</li>
     * * <li>The action of the callback is {@link BpProfile#ACTION_HISTORICAL_OVER_BP}.</li>
     * <li>Thr Keys of return message will show in the KeyList of {@link BpProfile#ACTION_HISTORICAL_OVER_BP}.</li>
     * </ul>
     */
    public void getOfflineDataOver() {
        a1InsSet.offlineDataOver();
    }
