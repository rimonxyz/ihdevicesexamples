...
public class KD926 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kd926);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.btn_getOffineDataOver:
                if(bp926Control != null)
                    bp926Control.getOfflineDataOver();
                else
                    Toast.makeText(this, "bp550BTControl == null", Toast.LENGTH_LONG).show();
                break;
