...
/**
 * Activity for testing Bp3L device. 
 */
public class BP3L extends Activity implements OnClickListener{

	private static final String TAG = "Bp3LDemo";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iHealthDevicesManager.getInstance().addCallbackFilterForDeviceType(clientCallbackId, iHealthDevicesManager.TYPE_BP3L);
		/* Get bp3 controller */
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_getbattery:
			if(bp3lControl != null)
				...
				Toast.makeText(BP3L.this, "bp3lControl == null", Toast.LENGTH_LONG).show();
			break;
